...
// MyProjectMFC2Dlg.cpp: 实现文件
//

#include "pch.h"
#include "framework.h"
#include "MyProjectMFC2.h"
#include "MyProjectMFC2Dlg.h"
		...
		if (clientproc.sClient[k1] != INVALID_SOCKET)
		{
			if ((rand() % 100) > 65) //1下子连接上去负担太重
			{
				...
				else
				{
					//connect成功
					int reco;
					//因为是阻塞式socket，所以设置收发数据超时时间，超过这个时间，则收发数据的函数会返回失败，这种写程序的方法会让写程序变得简单。
					reco = setsockopt(clientproc.sClient[k1], SOL_SOCKET, SO_RCVTIMEO, (LPCTSTR)& iRecvTimeOut, sizeof(int));
					reco = setsockopt(clientproc.sClient[k1], SOL_SOCKET, SO_SNDTIMEO, (LPCTSTR)& iRecvTimeOut, sizeof(int));
					clientproc.sign[k1] = 1; //表连接成功标志
					InterlockedIncrement(&g_connecting);
...
// CMyProjectMFC2Dlg 对话框



CMyProjectMFC2Dlg::CMyProjectMFC2Dlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MYPROJECTMFC2_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CMyProjectMFC2Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_BUTTON3, m_btnss);
	DDX_Control(pDX, IDC_LIST1, m_list);
	DDX_Control(pDX, IDC_BUTTON2, m_pausebtn);
}

BEGIN_MESSAGE_MAP(CMyProjectMFC2Dlg, CDialogEx)
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CMyProjectMFC2Dlg::OnBnClickedButton1)
	ON_BN_CLICKED(IDC_BUTTON2, &CMyProjectMFC2Dlg::OnBnClickedButton2)
	ON_BN_CLICKED(IDC_BUTTON3, &CMyProjectMFC2Dlg::OnBnClickedButton3)
	ON_BN_CLICKED(IDC_BUTTON4, &CMyProjectMFC2Dlg::OnBnClickedButton4)
	ON_BN_CLICKED(IDC_BUTTON5, &CMyProjectMFC2Dlg::OnBnClickedButton5)
	ON_BN_CLICKED(IDC_BUTTON6, &CMyProjectMFC2Dlg::OnBnClickedButton6)
END_MESSAGE_MAP()


// CMyProjectMFC2Dlg 消息处理程序

BOOL CMyProjectMFC2Dlg::OnInitDialog()
{
...
void CMyProjectMFC2Dlg::OnPaint()
{
	if (IsIconic())
	{
...
//显示。
HCURSOR CMyProjectMFC2Dlg::OnQueryDragIcon()
{
...
//开始测试按钮
void CMyProjectMFC2Dlg::OnBnClickedButton1()
{
	// TODO: 在此添加控件通知处理程序代码
	WSADATA       wsd;
...
//暂停测试按钮
void CMyProjectMFC2Dlg::OnBnClickedButton2()
{
	// TODO: 在此添加控件通知处理程序代码
	if (g_ifpausetest == 0)
	{
...
//暂停/继续模拟断线按钮
void CMyProjectMFC2Dlg::OnBnClickedButton3()
{
	// TODO: 在此添加控件通知处理程序代码	
	if (g_ifstopmoniduan == 1)
	{
...
//刷新信息按钮
void CMyProjectMFC2Dlg::OnBnClickedButton4()
{
	// TODO: 在此添加控件通知处理程序代码
	// TODO: 在此添加控件通知处理程序代码
	char buffer[200];
...
//清空信息按钮
void CMyProjectMFC2Dlg::OnBnClickedButton5()
{
	// TODO: 在此添加控件通知处理程序代码
	m_list.ResetContent();
}
...
//复位全部数据按钮
void CMyProjectMFC2Dlg::OnBnClickedButton6()
{
	// TODO: 在此添加控件通知处理程序代码
	//复位所有数据，清0的意思
