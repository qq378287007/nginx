...
BEGIN_MESSAGE_MAP(CMyProjectMFCDlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_BUTTON4, &CMyProjectMFCDlg::OnBnClickedButton4)
	ON_BN_CLICKED(IDC_BUTTON5, &CMyProjectMFCDlg::OnBnClickedButton5)
END_MESSAGE_MAP()
...
void CMyProjectMFCDlg::OnBnClickedButton2()
{
	...
	*/
	...
	if (getsockopt(sClient, SOL_SOCKET, SO_RCVBUF, (char*)& optVal, &opt_len) != SOCKET_ERROR)
	{
		int a;
		a = 1;
	}
...
void CMyProjectMFCDlg::OnBnClickedButton4()
{
	// TODO: 在此添加控件通知处理程序代码	
	CCRC32* p_crc32 = CCRC32::GetInstance();
...
//测试flood攻击
void CMyProjectMFCDlg::OnBnClickedButton5()
{
	// TODO: 在此添加控件通知处理程序代码
	CCRC32* p_crc32 = CCRC32::GetInstance();
